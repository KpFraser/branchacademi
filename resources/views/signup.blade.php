...
<html lang="en">
    ...
    <head>
        ...
        <!-- CSRF Token -->
        <meta name="csrf-token" content="cFUhlLNaxdqfoTdXU9EbbuhnJSrz2Z2eoKARnbZd">

        <title>Branch Academi</title>
        ...
        <div class="card overflow-hidden">
            <div class="grid grid-cols-12">
                <div class="col-span-12 lg:col-span-6">
                    <div class="p-4"><img class="hidden lg:block"
                            src="http://127.0.0.1:8000/img/SignUp2.svg" alt="" /></div>
                </div>
                <div class="col-span-12 lg:col-span-6 flex items-center">
                    <div class="p-4">
                        <form action="">
                            <div class="mb-3"><input class="ul-form-input" type="text" placeholder="Username" /></div>
                            <div class="mb-3"><input class="ul-form-input" type="password" placeholder="Password" />
                            </div>
                            ...
                            <div class="mb-4">
                                <div class="flex flex-wrap items-center"><button class="btn btn btn-primary mr-2 "
                                        type="button">Sign In</button>
                                    <p class="font-bold text-sm mr-2">Or</p><a
                                        class="text-primary-500 font-bold text-xl hover:text-primary-500" href="#">Sign
                                        Up</a>
                                </div>
                            </div>
                        </form>
