...
<script>
    ...
    <div class="flex items-center">
        ...
        <div class="mr-0 ul-dropdown md:mr-2" id="dropdownWrapper"><button class="btn btn-sm"
            ...
            <div class="dropdown-menu"><a class="dropdown-item" href="#">Folio</a><a class="dropdown-item"
                    href="#">Chat</a><a class="dropdown-item" href="#"> Sign Out</a></div>
        </div>
    </div>
</div>
    ...
    <div class="breadcrumb flex items-center border-b border-gray-300 pb-4 mb-6">
        ...
        <ul>
            <li class="border-r border-gray-400"><a class="hover:text-gray-800" href="">All</a></li>
            <li class="border-r border-gray-400"><a class="hover:text-gray-800" href="">Current</a></li>
            <li class="border-r border-gray-400"><a class="hover:text-gray-800" href="">Proposed</a></li>
              <li                               ><a class="hover:text-gray-800" href="">NEW</a></li>
        </ul>
    </div>
</div>
