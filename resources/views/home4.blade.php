	<x-master-layout>
	    ...
	    <section class="main-content">
	        <div class="grid lg:grid-cols-2 md:grid-cols-1 py-9 items-center justify-items-center">
	            <div class="py-3">
	                <h1 class="text-4xl leading-normal font-bold">With the right<br> support,<br>
	                    <x-tagui.span spanClass="text-red-600" spanText="anything's possibles"></x-tagui.span>
	                ...
	                <x-tagui.para paraClass="text-sm text-gray-600" paraText="Give yourself the connections needed to achieve"></x-tagui.para>
									<x-tagui.button buttonType="button" buttonClass="p-3.5 bg-red-600    text-white hover:bg-red-600 mt-3"    buttonText="Get Started" module="customButton"></x-tagui.button>
